...
export function NavArrow() {
    ...
    const index = sections.indexOf(location.hash) === -1 ? 0 : sections.indexOf(location.hash);
    ...
    useEffect(() => {
        const handleScroll = () => {
            const elementPosition =
                (ref.current as unknown as HTMLAnchorElement).getBoundingClientRect().top + window.scrollY;
