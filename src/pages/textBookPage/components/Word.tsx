...
const StyledWord = styled("li")<{ $modifier: WordModifierType | undefined }>`
    ...
    opacity: ${props => (props.$modifier && props.$modifier.isItLearned ? "0.5" : "1")};

    background-color: ${props =>
      props.$modifier && props.$modifier.isItOdd ? "rgba(233, 197, 106, 0.2)" : "rgba(42, 157, 144, 0.2)"};
    ...
    .word__transcription {
        color: ${props => (props.$modifier && props.$modifier.isItOdd ? "rgb(42, 157, 143)" : "rgb(233, 196, 106)")};
    }
